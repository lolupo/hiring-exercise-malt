...
class ApplicationTests {
    ...
    fun `test add and search commission rate`() {
        ...
        val addResponse: ResponseEntity<CommissionRate> =
            restTemplate.postForEntity("/v1/commission-rate/add", request, CommissionRate::class.java)
        ...
        val searchResponse: ResponseEntity<Response> =
            restTemplate.exchange("/v1/commission-rate/rate", HttpMethod.POST, searchRequest, Response::class.java)
